...
dump_db:
	...
	python manage.py dumpdata website.Club > 2-touchbelgium-clubs.json --indent 2
	...
	python manage.py dumpdata website.BelgianClub > 3-touchbelgium-belgian-clubs.json --indent 2
